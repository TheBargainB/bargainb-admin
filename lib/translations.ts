export type LanguageCode = 'nl' | 'en' | 'de' | 'fr' | 'it' | 'es' | 'ar'
...
export const translations: Record<LanguageCode, Translations> = {
  ...
  ar: {
    hero: {
      waitingBadge: "أشخاص ينتظرون بالفعل",
      peopleWaiting: "أشخاص ينتظرون بالفعل",
      earlyAccess: "الوصول المبكر",
      bargainB: "BargainB",
      description: "احصل على أول وصول إلى أذكى طريقة لتوفير المال على مشترياتك.",
      firstAccess: "الوصول الأول",
      exclusiveWhatsApp: "حصريًا عبر واتساب."
    },
    form: {
      phoneLabel: "رقم هاتفك المحمول",
      phonePlaceholder: "6 12345678",
      submitButton: "احصل على الوصول المبكر 🚀",
      submitting: "يرجى الانتظار...",
      successMessage: "✅ ممتاز! سنرسل رسالة واتساب إلى",
      successDescription: "أنت الآن في قائمة الوصول المبكر!"
    },
    socialProof: {
      joinText: "انضم إلى",
      earlyAdopters: "المتبنين الأوائل"
    },
    faq: {
      title: "الأسئلة الشائعة",
      questions: {
        whatIs: {
          question: "ما هو الوصول المبكر لـ BargainB؟",
          answer: "احصل على أول وصول إلى BargainB واكتشف أفضل عروض السوبر ماركت عبر واتساب. يحصل المستخدمون الأوائل على فوائد حصرية وخصومات."
        },
        whenAccess: {
          question: "متى سأحصل على الوصول؟",
          answer: "يحصل مستخدمو الوصول المبكر على وصول إلى نسخة تجريبية من BargainB خلال 2-3 أسابيع. ستتلقى رسالة واتساب بمجرد أن تكون حسابك جاهزًا."
        },
        benefits: {
          question: "ما هي فوائد الوصول المبكر؟",
          answer: "خصومات حصرية، ميزات مميزة، دعم ذو أولوية، وفرصة المساعدة في بناء مستقبل التسوق الذكي."
        },
        free: {
          question: "هل الوصول المبكر مجاني؟",
          answer: "نعم! الوصول المبكر مجاني تمامًا. يحصل المستخدمون الأوائل حتى على فوائد إضافية وخصومات لن تكون متاحة لاحقًا."
        }
      }
    },
    finalCta: {
      question: "هل أنت مستعد لبدء التسوق الذكي؟",
      action: "أدخل رقمك أعلاه"
    },
    validation: {
      phoneLength: "يجب أن يحتوي رقم الهاتف المحمول على 9 أرقام بالضبط (6 + 8 أرقام)",
      phoneFormat: "يجب أن يبدأ رقم الهاتف المحمول بـ 6",
      phoneNumbers: "يمكن أن يحتوي رقم الهاتف المحمول على أرقام فقط"
    },
    toast: {
      success: {
        title: "تهانينا! 🎉",
        description: "أنت الآن في قائمة الوصول المبكر!"
      },
      exists: {
        title: "أنت بالفعل في القائمة! 📱",
        description: "سنرسل لك رسالة واتساب قريبًا."
      },
      error: {
        title: "عذرًا! 😅",
    ...
    onboarding: {
      ...
      step3: {
        title: "موقعك",
        description: "ساعدنا في تخصيص تجربتك من خلال مشاركة موقعك.",
        country: "البلد",
        city: "المدينة",
        countryPlaceholder: "اختر بلدك",
        cityPlaceholder: "مثال: أمستردام، بروكسل، برلين",
        countryHelper: "اختر البلد الذي ستتسوق فيه.",
        cityHelper: "أدخل المدينة التي ستتسوق فيها للطعام.",
        countryRequired: "البلد مطلوب",
        cityRequired: "المدينة مطلوبة"
      },
      step4: {
        title: "اختر متاجر البقالة الخاصة بك",
        description: "اختر متاجر البقالة التي تحب التسوق فيها. يمكنك اختيار متاجر متعددة.",
        selectedStores: "المتاجر المختارة",
        helpText: "لا تقلق، يمكنك دائمًا تغيير تفضيلاتك لاحقًا في الإعدادات."
      },
      step5: {
        title: "التفضيلات الغذائية والحساسية",
        description: "ساعدنا في تخصيص تجربة التسوق الخاصة بك من خلال مشاركة احتياجاتك الغذائية والحساسية.",
        dietaryPreferences: "التفضيلات الغذائية",
        foodAllergies: "الحساسية الغذائية",
        yourSelections: "اختياراتك",
        helpText: "هذه المعلومات تساعدنا في اقتراح منتجات مناسبة وتصفية العناصر التي لا تناسب احتياجاتك.",
        dietaryOptions: {
          vegetarian: "نباتي",
          vegan: "نباتي صرف",
      ...
      step6: {
        title: "أنشئ قائمة التسوق الخاصة بك",
        description: "اختر من القوائم الجاهزة أو ارفع صورًا من ثلاجتك/مخزنك للحصول على اقتراحات مخصصة.",
        quickStartLists: "قوائم البداية السريعة",
        smartAnalysis: "تحليل ذكي",
        fridgeDescription: "شاهد ما ينفد منك",
        pantryDescription: "راجع أساسياتك",
        shoppingListDescription: "ارفع قائمتك المكتوبة",
        upload: "رفع",
        camera: "الكاميرا",
        analyzing: "تحليل صورتك...",
        aiSuggestions: "اقتراحات الذكاء الاصطناعي",
        yourShoppingList: "قائمة التسوق الخاصة بك",
        helpText: "سيحلل الذكاء الاصطناعي صورك لاقتراح العناصر التي قد تحتاجها. يمكنك دائمًا إضافة أو إزالة العناصر."
      },
      step7: {
        title: "اختر تكامل الذكاء الاصطناعي الخاص بك",
        description: "اختر أين تريد استخدام مساعد التسوق الذكي الخاص بك. يمكنك دائمًا إضافة المزيد لاحقًا.",
        availablePlatforms: "المنصات المتاحة",
        popular: "شائع",
        comingSoon: "قريبًا",
        selected: "مختار",
        selectedIntegrations: "التكاملات المختارة",
        whatsappBenefits: "📱 فوائد تكامل واتساب:",
        benefit1: "• احصل على اقتراحات تسوق فورية",
        benefit2: "• شارك الصور لقوائم تسوق ذكية",
        benefit3: "• احصل على توصيات وجبات مخصصة",
        benefit4: "• تتبع تقدم التسوق الخاص بك",
        skipForNow: "تخطي الآن",
        helpText: "لا تقلق! يمكنك دائمًا تمكين المزيد من التكاملات لاحقًا من إعدادات لوحة التحكم الخاصة بك."
      },
      completion: {
        welcomeTitle: "مرحبًا بك في BargainB!",
        welcomeDescWhatsApp: "ملفك الشخصي جاهز! ستتلقى رسالة واتساب قريبًا لبدء استخدام مساعد التسوق الذكي الخاص بك.",
        welcomeDescDefault: "ملفك الشخصي جاهز! يمكنك بدء استخدام BargainB في أي وقت من خلال تمكين التكاملات من إعداداتك.",
        profileSummaryTitle: "ملخص ملفك الشخصي",
        location: "الموقع",
        groceryStores: "متاجر البقالة",
        dietaryPreferences: "التفضيلات الغذائية",
        foodAllergies: "الحساسية الغذائية",
        initialGroceryList: "قائمة البقالة الأولية",
        aiIntegrations: "تكاملات الذكاء الاصطناعي",
        items: "عناصر",
        whatsappIntegrationActive: "تكامل واتساب نشط",
        whatsappIntegrationDesc: "ابحث عن رسالة من BargainB على واتساب في",
        whatsappIntegrationDescContinued: "سيساعدك مساعد الذكاء الاصطناعي في التسوق وتخطيط الوجبات والمزيد!",
        completeSetup: "إكمال الإعداد",
        setupCompleteTitle: "اكتمل الإعداد!",
        checkWhatsappDesc: "تحقق من واتساب للحصول على رسالة من BargainB!",
        profileCreatedTitle: "تم إنشاء الملف الشخصي!",
        enableIntegrationsDesc: "يمكنك تمكين التكاملات في أي وقت من الإعدادات."
      }
    }
  }
}
